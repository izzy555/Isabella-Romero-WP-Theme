 ...
 */
 function isabellaromero_theme_scripts() {
     wp_enqueue_style( 'isabellaromero', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'isabellaromero_theme_scripts' );
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'isabella-romero' ),
            'footer-menu' => __( 'Footer Menu', 'isabella-romero' ),
            'social-menu' => __( 'Social Menu', 'isabella-romero'),
    ...
    function isabellaromero_theme_init(){
    ...
    add_action( 'widgets_init', 'isabellaromero_widgets_init' );
